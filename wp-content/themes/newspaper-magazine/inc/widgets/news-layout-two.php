...
if ( ! function_exists( 'newspaper_magazine_news_layout_two_register' ) ) :
	function newspaper_magazine_news_layout_two_register() {
		/**
		 * Register Widget
		 */
		register_widget( 'Newspaper_Magazine_News_Layout_Two' );
	}
endif;
add_action( 'widgets_init', 'newspaper_magazine_news_layout_two_register' );

if ( ! class_exists( 'Newspaper_Magazine_News_Layout_Two' ) ) :
	/**
	* News Layout Class Two
	*/
	class Newspaper_Magazine_News_Layout_Two extends WP_Widget
	{
		
		function __construct()
		{
			$opts = array(
				'classname' => 'world_news wow fadeInUp',
		...
		function widget( $args, $instance ){
			...
			echo $args[ 'before_widget' ];
				...
				?>
				<div class="row latest_world_two_news">
				<?php
					if( $query->have_posts() ) :
				...
				<div class="row latest_world_bottom_news clearfix gird">
				<?php
					if( $query->have_posts() ) :
						while( $query->have_posts() ) :
							$query->the_post();
